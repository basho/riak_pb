...
type RpbBucketProps struct {
	...
	Repl   *RpbBucketProps_RpbReplMode `protobuf:"varint,24,opt,name=repl,enum=riak_pb.RpbBucketProps_RpbReplMode" json:"repl,omitempty"`
	// Search index
...
func init() {
	proto.RegisterEnum("riak_pb.RpbBucketProps_RpbReplMode", RpbBucketProps_RpbReplMode_name, RpbBucketProps_RpbReplMode_value)
}
