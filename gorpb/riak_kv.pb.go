...
type RpbIndexReq struct {
	...
	Qtype        *RpbIndexReq_IndexQueryType `protobuf:"varint,3,req,name=qtype,enum=riak_pb.RpbIndexReq_IndexQueryType" json:"qtype,omitempty"`
...
func init() {
	proto.RegisterEnum("riak_pb.RpbIndexReq_IndexQueryType", RpbIndexReq_IndexQueryType_name, RpbIndexReq_IndexQueryType_value)
}
